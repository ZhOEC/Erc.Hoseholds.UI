...
import { PaymentBatchAddComponent } from './modules/payments/payment-batch-add/payment-batch-add.component';
...
const routes: Routes = [
  ...
  { path: 'payment-batch-add', component: PaymentBatchAddComponent }
];
