...
import { IStreet } from './shared/street';
...
export class AddressService {  
    ...
    getCities(branchOfficeId: number): Observable<ICity[]> {
        ...
        return this.http
            .get<ICity[]>(environment.apiServer + "address/cities", { params: queryParams })
    }
    ...
    getStreets(cityId: number): Observable<IStreet[]> {
        ...
        return this.http
            .get<IStreet[]>(environment.apiServer + "address/streets", { params: queryParams })
    }
}